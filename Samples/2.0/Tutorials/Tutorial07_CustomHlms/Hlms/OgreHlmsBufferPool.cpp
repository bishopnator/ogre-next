...
{
	// DestroyAllBuffers was not called by the implementation.
	assert(mBuffers.empty());
}

//////////////////////////////////////////////////////////////////////////
void HlmsBufferPool::setBinding(uint8_t stages, uint16_t slot)
{
	if (mStartPtr != nullptr)
		OGRE_EXCEPT(Exception::ERR_INVALIDPARAMS, "Cannot change binding in the middle of rendering.", "HlmsBufferPool::SetBinding");
...
//////////////////////////////////////////////////////////////////////////
void HlmsBufferPool::setRenderSystem(Ogre::RenderSystem* pRenderSystem)
{
